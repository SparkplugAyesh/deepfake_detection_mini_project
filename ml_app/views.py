...
def predict_page(request):
    if request.method == "GET":
        ...
        for i in range(1, sequence_length+1):
            ...
            image_name = video_file_name_only+"preprocessed"+str(i)+'.png'
            if settings.DEBUG:
        ...
        for i in range(1, sequence_length+1):
            ...
            img = pImage.fromarray(image, 'RGB')
            image_name = video_file_name_only+"cropped_faces"+str(i)+'.png'
            if settings.DEBUG:
                image_path = os.path.join(settings.PROJECT_DIR, 'uploaded_images', video_file_name_only+"cropped_faces"+str(i)+'.png')
            else:
                image_path = "/home/app/staticfiles" + image_name
            img.save(image_path)
